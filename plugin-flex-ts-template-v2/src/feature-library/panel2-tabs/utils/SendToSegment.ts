...
class SendToSegmentService extends ApiService {
  push = async (email: string, summary: string, sentiment: string, language: string): Promise<any> => {
...
export default new SendToSegmentService();
