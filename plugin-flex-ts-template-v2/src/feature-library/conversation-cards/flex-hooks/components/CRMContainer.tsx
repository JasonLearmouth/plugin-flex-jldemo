...
import ConversationCardsCRM from '../../custom-components/ConversationCardsCRM';
...
export const componentHook = function addCannedResponsesCRMContainer(flex: typeof Flex, _manager: Flex.Manager) {
  ...
  flex.CRMContainer.Content.replace(<ConversationCardsCRM key="canned-responses-crm-container" />, options);
};
